...
<head>
	...
	<script type="text/javascript" src="<?php echo $this->project_admin_path;?>js/menu_1_popup_modify.js<?php echo $version;?>"></script>
</head>
<body>
	<div class="wrap">
        ...
        <?php include_once $dir."page/adm/include/adm_header.php";?>
			<div class="bd">
				<article class="body-container">
					<div class="body-head"><h2>팝업 수정</h2></div>
								...
								<div class="body-box mt-1">
									<div class="box-table-container">
										...
										<dl class="box-tbody">
											...
											<dd class="box-td">
												<div class="insert insert-input">
													<input type="text" class="input-sm" placeholder = "www를 제외하고 입력해야합니다." name="link" id="link"/>
												</div>
												<p class="xsmall mt-1">팝업 클릭 시 이동할 링크 수정</p>
											</dd>
										</dl>
										<dl class="box-tbody">
											<dt class="box-th box-head">
											...
											<dd class="box-td">
                                                ...
                                                <div class="img-upload img-upload-main" style="overflow: hidden;">
                                                    <span class="btn-wrap" id="file_input_wrap">
                                                        <button class="btn-img-upload" href="#"><strong></strong></button>
                                                        <input type="file" id="pc_img_file" name="pc_popup_files[]" onchange="add_image_file(this);">
                                                    </span> 				
                                                    <label for="pc_img_file" id="pc_img_label"></label>
                                                </div>
                                                <!-- 이미지 수정 버튼 // -->
                                                <!-- 이미지가 첨부될 시 옆에 나열됩니다 -->
                                                <div data-wrap="pc_img_wrap" style = "display:inline-block" id="pc_img_wrap">
	...
	<div style="display:none;">
		...
		<div class="insert insert-chk" data-copy="copy_radio">
			<label class="check_label" for="radio_1" data-attr="label">KOR<input type="radio" id="radio_1" value="1" name="lang" checked=""><span class="checkmark radio"></span></label>
		</div>

		<div class="img-upload" style="overflow: hidden;" data-copy = "img_copy" id="img_copy">
            <img src="" data-attr="img" alt="img_upload"/>
            <button  data-attr="del_btn" class="delete-btn" type="button" onclick="delete_image(this);"></button>
        </div>
	</div>
</body>
<!-- select2 -->
