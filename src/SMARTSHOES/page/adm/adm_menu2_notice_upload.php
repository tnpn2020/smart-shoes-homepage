...
<head>
	...
	<script type="text/javascript"
		src="<?php echo $this->project_admin_path;?>js/menu_2_notice_upload.js<?php echo $version;?>"></script>
</head>
...
<body>
	...
	<div style = "display:none">
		...
		<div class="insert insert-input" id="file_upload_copy">
			<input class="input-sm" type="file" data-attr = "file" name="add_file[]" style="display: none;" onchange="add_file(this)">
			<input class="input-sm" readonly="true" type="text" data-attr = "file_name" style="margin-right: 10px;">
			<label for="add_file_input_0" data-attr = "file_label" class="file-upload btn-primary" style="margin-right: 5px; cursor: pointer;">파일첨부</label>
			<label class="file-upload btn-default" data-attr = "del_file_btn" style="cursor: pointer;" onclick="file_remove()">삭제</label>
		</div>
	</div>
