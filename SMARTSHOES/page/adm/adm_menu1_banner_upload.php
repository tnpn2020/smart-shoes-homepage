...
<head>
	...
	<script type="text/javascript" src="<?php echo $this->project_admin_path;?>js/menu_1_banner_main_upload.js<?php echo $version;?>"></script>
</head>
<body>
	<div class="wrap">
        ...
        <?php include_once $dir."page/adm/include/adm_header.php";?>
			<div class="bd">
				<article class="body-container">
					<div class="body-head"><h2>메인이미지 등록</h2></div>
											...
											<dd class="box-td">
                                                ...
                                                <div class="img-upload img-upload-main" style="overflow: hidden;">
                                                    <span class="btn-wrap">
                                                        ...
                                                        <input type="file" id="pc_img_file" name="pc_banner_files[]">
                                                    </span> 				
                    ...
                    <div class="btn-container align-right mt-3">
						<button type="button" class="btn btn-ghost" onclick="location.href='?ctl=move&param=adm&param1=menu1_banner';">취소</button>
