...
<head>
	...
	<script type="text/javascript" src="<?php echo $this->project_admin_path;?>/js/menu_1_banner_main.js<?php echo $version;?>"></script>
</head>
<body>
		...
		<div class="modal-wrap modal-sm">
			<div class="modal-container">
				...
				<div class="modal-container-inner">
					<div class="modal-head bold">배너수정</div>
							...
							<div class="box-table-container">
								...
								<div class="mt-2">
									<div class="insert insert-input">
										...
										<input type="text" class="input-lg" id="modify_banner_title" placeholder="쇼핑몰에서 보여지는 타이틀 입력">
									</div>
								</div>
								<div class="mt-2">
									<div class="insert insert-input">
										<p class="mb-1 bold">배너 내용</p>
										<input type="text" class="input-lg" id="modify_banner_content" placeholder="쇼핑몰에서 보여지는 내용 입력">
									</div>
								</div>
							</div>
						</div>
					...
					<ul class="btn-container align-right">
						...
						<li><button type="button" class="btn btn-primary" onclick="request_modify_banner()">수정</button></li>
					</ul>
				</div>
				<!-- 모달 본문 // -->
			</div>
        ...
        <?php include_once $dir."page/adm/include/adm_header.php";?>
			<div class="bd">
				<article class="body-container">
					<div class="body-head"><h2>메인이미지 관리</h2></div>
							...
							<div class="row p-relative mt-2">
								<div class="col-md-9">
									...
									<div class="btn-container align-right mt-3">
										<button type="button" class="btn btn-primary" onclick="move_upload()">메인이미지 등록</button>
									</div>
								</div>
								<div class="col-md-1">
			...
			<tr data-copy="copy">
				...
				<td class="col-img">
					<div class="table-thumb">
						<img src="<?php echo $this->project_admin_image_path;?>images/sample2.png" data-attr="img_pc_banner" alt="상품이미지"/>
					</div>
				</td>
				<!-- <td class="col-img">
					<div class="table-thumb">
						<img src="<?php echo $this->project_admin_image_path;?>images/sample2.png" data-attr="img_m_banner" alt="상품이미지"/>
					</div>
					
				</td> -->
				<!-- <td class="col-img">
					<div class="table-thumb">
						<img src="<?php echo $this->project_admin_image_path;?>images/sample2.png" data-attr="img_s_banner" alt="상품이미지"/>
					</div>
				...
				<!-- <td class="col-tit">
					<div class="table-tit">
						<p class="tit"><span onclick="" data-attr="name">파일명을 보여줍니다.</span></p>
					</div>
				</td> -->
				...
				<td class="col-long-num"><input class="btn-default btn-32" type="button" value="수정하기" data-attr="btn_modify"></td>
			</tr>
		</table>
