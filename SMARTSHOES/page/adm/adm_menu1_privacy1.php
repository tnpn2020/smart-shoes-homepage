...
<head>
	...
	<script type="text/javascript" src="<?php echo $this->project_admin_path;?>js/menu1_privacy1.js<?php echo $version;?>"></script>
        ...
        <?php include_once $dir."page/adm/include/adm_header.php";?>
			<div class="bd">
				<article class="body-container">
					<div class="body-head mb-1"><h2>개인정보방침 설정</h2></div>
